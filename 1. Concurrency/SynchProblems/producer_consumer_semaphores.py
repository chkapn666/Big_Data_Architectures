...
# A way to completely solve this issue is via using semaphores. Semaphores are also always linked to a lock, so we first define a lock
# before defining the semaphore.
...
def producer():
    ...
    for i in range(NITEMS):
        ...
        mutex.acquire()  # should a producer be able to produce, they will ensure exclusive access to the shared resource - the buffer
        buffer[nextin] = i
